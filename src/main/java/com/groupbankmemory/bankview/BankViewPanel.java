package com.groupbankmemory.bankview;

import com.groupbankmemory.util.Constants;
import com.groupbankmemory.util.OnAnyChangeDocumentListener;
...
import static com.groupbankmemory.util.Constants.PAD;
...
public class BankViewPanel extends JPanel {
    ...
    public BankViewPanel() {
        ...
        errorPanel.setContent(Constants.GROUP_BANK_MEMORY,
